...
namespace ThemeManager
{
  ...
  void ApplyTheme(AppTheme theme)
  {
    ...
    case AppTheme::Monokai_Classic:
      ...
      break;
    case AppTheme::Cyberpunk_Neon:
      ApplyCyberpunkNeonTheme();
      break;
    case AppTheme::Synthwave_Sunset:
      ApplySynthwaveSunsetTheme();
      break;
    case AppTheme::Dracula_Official:
      ApplyDraculaOfficialTheme();
      break;
    case AppTheme::One_Dark_Pro:
      ApplyOneDarkProTheme();
      break;
    case AppTheme::Volcanic_Obsidian:
      ApplyVolcanicObsidianTheme();
      break;
    case AppTheme::Deep_Forest_Gold:
      ApplyDeepForestGoldTheme();
      break;
    case AppTheme::Galactic_Nebula:
      ApplyGalacticNebulaTheme();
      break;
    case AppTheme::Royal_Amethyst:
      ApplyRoyalAmethystTheme();
      break;
    case AppTheme::Matrix_Code:
      ApplyMatrixCodeTheme();
      break;
    case AppTheme::Molten_Gold:
      ApplyMoltenGoldTheme();
      break;
    case AppTheme::C8bit_Commodore:
      Apply8bitCommodoreTheme();
      break;
    case AppTheme::Vaporwave_Dream:
      ApplyVaporwaveDreamTheme();
      break;
    case AppTheme::Atom_Inspired:
      ApplyAtomInspiredTheme();
      break;
    case AppTheme::Midnight_Ocean:
      ApplyMidnightOceanTheme();
      break;
    case AppTheme::Ruby_Glow:
      ApplyRubyGlowTheme();
      break;
    case AppTheme::Stanford_Cardinal_Light:
      ApplyStanfordCardinalLightTheme();
      break;
    case AppTheme::Paper_White:
      ApplyPaperWhiteTheme();
      break;
    case AppTheme::Clean_Slate_Blue:
      ApplyCleanSlateBlueTheme();
      break;
    case AppTheme::Nordic_Light:
      ApplyNordicLightTheme();
      break;
    case AppTheme::Sahara_Cream:
      ApplySaharaCreamTheme();
      break;
    case AppTheme::Kyoto_Sakura:
      ApplyKyotoSakuraTheme();
      break;
    case AppTheme::Spring_Mint:
      ApplySpringMintTheme();
      break;
    case AppTheme::Aqua_Marine:
      ApplyAquaMarineTheme();
      break;
    case AppTheme::Lavender_Haze:
      ApplyLavenderHazeTheme();
      break;
    case AppTheme::Peach_Sorbet:
      ApplyPeachSorbetTheme();
      break;
    case AppTheme::Sunny_Citrus:
      ApplySunnyCitrusTheme();
      break;
    case AppTheme::Harvard_Crimson:
      ApplyHarvardCrimsonTheme();
      break;
    case AppTheme::Oxford_Blue:
      ApplyOxfordBlueTheme();
      break;
    case AppTheme::Silverlight:
      ApplySilverlightTheme();
      break;
    case AppTheme::Alabaster_Shell:
      ApplyAlabasterShellTheme();
      break;
    case AppTheme::Coral_Reef:
      ApplyCoralReefTheme();
      break;
